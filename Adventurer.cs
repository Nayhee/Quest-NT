namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        public Adventurer(string name, Robe colorfulRobe, Hat hat, int numberCorrect)
        {
            Name = name;
            Awesomeness = 50;
        ...
        {
            string robeString = $"Your Robes colors: ";
            foreach (string robeColor in ColorfulRobe.Colors)
            {
                robeString += $"{robeColor}, ";
            }
            robeString += $"your robes length is {ColorfulRobe.Length}, ";
            robeString += $"and your Hat is {Hat.ShininessDescription()}, ";
            return robeString;
        }
